...
The flowchart in figure \ref{fig:AttackCoordinator::requestAttack()} shows an attack squad requesting an attack from attack coordinator. It can either get an weightened attack location or join the teammate's frontal attack, if s/he has one.
\begin{figure}[htb]
\centering
