...
%%%%%%%%%%%%%%%%% LEGENDS %%%%%%%%%%%%%%%%%%%
% Lines
\newbox{\LegendLineCyan}
\savebox{\LegendLineCyan}{
	(\tikz[baseline=-0.65ex]{\draw[cyan,line width=2pt] (0,0) -- (0.5, 0); })
}

\newbox{\LegendLineLightGreen}
\savebox{\LegendLineLightGreen}{
	(\tikz[baseline=-0.65ex]{\draw[LightGreen,line width=2pt] (0,0) -- (0.5, 0); })
}

\newbox{\LegendLineLightBlue}
\savebox{\LegendLineLightBlue}{
	(\tikz[baseline=-0.65ex]{\draw[LightBlue,line width=2pt] (0,0) -- (0.5, 0); })
}

\newbox{\LegendLineLightGreenLightBlue}
\savebox{\LegendLineLightGreenLightBlue}{
	(\tikz[baseline=-0.65ex]{\draw[LightGreen,line width=2pt] (0,-0.05) -- (0.5, -0.05); 
	\draw[LightBlue, line width=2pt] (0,0.05) -- (0.5, 0.05); })
}

\newbox{\LegendLineRed}
\savebox{\LegendLineRed}{
	(\tikz[baseline=-0.65ex]{\draw[Red,line width=2pt] (0,0) -- (0.5, 0); })
}

\newbox{\LegendLineYellow}
\savebox{\LegendLineYellow}{
	(\tikz[baseline=-0.65ex]{\draw[Yellow,line width=2pt] (0,0) -- (0.5, 0); })
}

% Dots
\newbox{\LegendDotGreen}
\savebox{\LegendDotGreen}{
	(\tikz[baseline=-0.75ex]{\draw[green,fill] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendDotOrange}
\savebox{\LegendDotOrange}{
	(\tikz[baseline=-0.75ex]{\draw[Orange,fill] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendDotYellow}
\savebox{\LegendDotYellow}{
	(\tikz[baseline=-0.75ex]{\draw[Yellow,fill] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendDotRed}
\savebox{\LegendDotRed}{
	(\tikz[baseline=-0.75ex]{\draw[red,fill] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendDotBlue}
\savebox{\LegendDotBlue}{
	(\tikz[baseline=-0.75ex]{\draw[blue,fill] (0.25, 0.0) circle(0.12);})
}

% Circles
\newbox{\LegendCircleRed}
\savebox{\LegendCircleRed}{
	(\tikz[baseline=-0.75ex,thick]{\draw[red] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendCircleBrown}
\savebox{\LegendCircleBrown}{
	(\tikz[baseline=-0.75ex,thick]{\draw[Brown] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendCircleViolet}
\savebox{\LegendCircleViolet}{
	(\tikz[baseline=-0.75ex,thick]{\draw[Violet] (0.25, 0.0) circle(0.12);})
}

\newbox{\LegendCircleGreen}
\savebox{\LegendCircleGreen}{
	(\tikz[baseline=-0.75ex,thick]{\draw[green] (0.25, 0.0) circle(0.12);})
}

% Boxes
\newbox{\LegendBoxYellow}
\savebox{\LegendBoxYellow}{
	(\tikz[baseline=-0.65ex]{\node[minimum width=2em, draw=green, thick, fill=yellow!50, rectangle]	(0,0) {}; })
}
...
\addcontentsline{toc}{chapter}{Bibliograhpy}
%
%\input{glossary}
%\input{index}
%\input{guide_symbols}
